...
public class RequestMoneyTests extends BaseTest {
    ...
    public void childSuccessfulMoneyRequestSubmissionTest() {
        bankSteps
    ...
    public void childMoneyRequestResponseBodyVerificationTest() {
        bankSteps
                .requestMoney(VALID_CHILD_ID, VALID_AMOUNT)
                .validateStatusCode(200)
                .validateResponseBodyIsNotEmpty();
    ...
    public void childMoneyRequestContentTypeVerificationTest() {
        bankSteps
                .requestMoney(VALID_CHILD_ID, VALID_AMOUNT)
                .validateStatusCode(200)
                .validateContentTypeIsJson();
    ...
    public void childMoneyRequestResponseTimeVerificationTest() {
        bankSteps
                .requestMoney(VALID_CHILD_ID, VALID_AMOUNT)
    ...
    public void childMoneyRequestSubmissionWithNegativeAmountTest() {
        bankSteps
    ...
    public void childMoneyRequestSubmissionWithNonExistentChildTest() {
        bankSteps
    ...
    public void childMoneyRequestErrorResponseDetailVerificationTest() {
        bankSteps
                .requestMoney(VALID_CHILD_ID, INVALID_AMOUNT)
                .validateStatusCode(400)
                .validateErrorDetailIsNotEmpty();
